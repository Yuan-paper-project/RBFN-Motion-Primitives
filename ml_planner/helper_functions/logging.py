...
def logger_initialization(log_path: str = "",
                          logger: str = "Interface_Logger",
                          loglevel: str = "DEBUG") -> logging.Logger:
    """
    ...
    log_formatter = logging.Formatter("%(levelname)-8s [%(asctime)s] (%(filename)s:%(lineno)s) --- %(message)s ",
                                      "%Y-%m-%d %H:%M:%S")
